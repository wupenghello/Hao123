...
const MOCK_TASKS: ZentaoTask[] = [
  {
    ...
    executionName: 'Sprint 24.07 前端冲刺',
  ...
  },
  {
    ...
    progress: 0,
    openedBy: '前端-赵越',
    openedDate: dateTimeFromNow(-6),
    lastEditedBy: '前端-赵越',
    lastEditedDate: dateTimeFromNow(-6),
  ...
  },
  {
    ...
    progress: 30,
    openedBy: '吴鹏',
    openedDate: dateTimeFromNow(-8),
    realStarted: dateTimeFromNow(-1),
    lastEditedBy: '吴鹏',
    lastEditedDate: dateTimeFromNow(-8),
