...
Comprehensive UI/UX design intelligence with searchable database. Contains 67 styles, 96 color palettes, 57 font pairings, 99 UX guidelines, and 25 chart types across 13 technology stacks.

## When to Use

Activate this skill when the user requests UI/UX work such as: design, build, create, implement, review, fix, or improve any user interface.

## Prerequisites

Check if Python 3 is available before using the scripts:
...
**Always run `--design-system` first** to get comprehensive recommendations with reasoning:
...
These are frequently overlooked issues that make UI look unprofessional. Always apply these rules:
